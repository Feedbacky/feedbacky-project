...
export const CLIENT_VERSION = "1.0.0.alpha.6";
...
const App = ({appearanceSettings}) => {
    ...
    useEffect(() => {
        ackeeInstance.action('8f766730-6d63-48ed-b203-e993e14e20e7', {key: appearance.mode + (appearance.systemDefault ? " (system)" : ""), value: 1});
